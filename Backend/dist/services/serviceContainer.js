...
function createServiceContainer() {
    if (env_1.env.MOCK_PROVIDERS) {
        ...
        const flightService = new flightService_1.FlightService(airports, (0, mockProviders_1.createMockFlightPlanProvider)(), (0, mockProviders_1.createMockWeatherProvider)(), (0, mockProviders_1.createMockFuelProvider)(), new flightTrackingProvider_1.MockFlightTrackingProvider());
        return {
            flightService,
